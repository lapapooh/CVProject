...
{
    public class HrCvMembershipService : BaseService<HrCvMembership>, IHrCvMembershipService
    {
        public HrCvMembershipService(IHrCvMembershipRepository repository,
        ...
        public void Save(IList<HrCvMembership> models, int cvDetailId)
        {
